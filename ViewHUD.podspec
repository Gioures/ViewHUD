#
#  Be sure to run `pod spec lint ViewHUD.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Gioures"
  # spec.authors            = { "Gioures" => "756119874@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Gioures"
